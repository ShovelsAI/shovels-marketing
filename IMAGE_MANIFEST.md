...
|---|---|---|---|---|---|
| [ ] | Hero | Hero | Figma | `hero.svg` | Insurance hero illustration |
| [ ] | UC1 | Screenshot | Notion | `uc1-underwrite.png` | Property detail showing permit history with additions, renovations, contractor names, and dates |
| [ ] | UC2 | Screenshot | Notion | `uc2-leads.png` | Permit search filtered to recent residential permits in a ZIP, showing type, job value, and address |
| [ ] | UC3 | Screenshot | Notion | `uc3-verify-claims.png` | Claim vs. permit-of-record comparison flagging a discrepancy |
| [ ] | UC4 | Screenshot | Notion | `uc4-close-gap.png` | Permit search filtered to additions and renovations in a target ZIP by date range |
| [ ] | UC5 | Illustration | Notion | `uc5-catastrophe.svg` | Cat-modeling team watching reconstruction permits spread across a storm-affected region |
