Title: Mixed-Use Zoning in Arizona
Subtitle: Analyzing all city decisions in AZ to explore mixed-use developments and gov. initiatives
Date: 2025-02-24
Modified: 2025-02-24
Category: Data
...
![Cosanti Commons Proposed Site Plan]({static}/images/rezone/Cosanti_Commons_Proposed_Site_Plan.png)
*Cosanti Commons Proposed Site Plan*
...
At ReZone, we like to cover new tools and approaches that cities can use to support developers. While GPLET has been [established by the State of Arizona](https://www.gilacountyaz.gov/government/assessor/government_property.php) since 1996, we've only recently started seeing a handful of GPLETs pass.
