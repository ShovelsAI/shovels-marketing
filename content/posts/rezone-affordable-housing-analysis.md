Title: How U.S. Cities Address Affordable Housing: A Nationwide Analysis
Subtitle: Using City Council Data to Reveal Trends, Tools, and Tactics in Affordable Housing Policy
Date: 2024-12-20
Modified: 2024-12-20
Category: Data
...
Slug: affordable-housing-city-council-analysis
Summary: A data-driven analysis of how America's largest cities tackle affordable housing through PILOTs, land releases, financing models, and more - based on city council decision data from ReZone (acquired by Shovels).
Image: /images/rezone/AffordableHousingDecisionsAsShareofTotalCityActivity.png
...
There's lots of talk about infamous affordability initiatives - like Section 8, or LIHTC - but what is happening on the ground day in and day out? Our goal is to understand the types of decisions being passed in America's largest cities and to identify similarities & differences.

![Affordable Housing Decisions as Share of Total City Council Activity]({static}/images/rezone/AffordableHousingDecisionsAsShareofTotalCityActivity.png)

Affordable housing is a widely discussed topic, but it's challenging to define. Most agree that Section 8, LIHTC, and public housing count towards affordable housing, but how about workforce housing, ADUs, and coliving concepts? Brad Hargreaves has written a [great piece](https://www.thesisdriven.com/p/so-you-want-to-build-affordable-housing) discussing different affordability business models, which we will use as our basis.
...
[Payment in lieu of taxes (PILOT)](https://en.wikipedia.org/wiki/Payment_in_lieu_of_taxes) agreements, property tax exemptions, and tax increment financing are widespread. Cities like Houston, New York, and Detroit often rely heavily on PILOTs, while San Francisco and Austin tend to use tax credits more frequently.
...
MRBs are [tax-exempt multifamily housing bonds](https://www.ncsha.org/resource/tax-exempt-housing-bonds-faq-mrbs/) used to finance the acquisition, construction, or rehabilitation of housing for low-income renters.
...
ReZone (acquired by Shovels) is primarily focused on developers, investors, and <a href="https://www.shovels.ai/real-estate" target="_blank">real estate professionals</a>, but if you are a policy maker, researcher, or academic and would like to <a href="https://www.shovels.ai/permit-database" target="_blank">explore the Shovels permit database</a>, we would love to connect.
