...
Author_title: CEO
Summary: Ryan shares a candid look at how Shovels has fully embraced AI—from Claude Code to OpenClaw—and reflects on what it means to be an entrepreneur in the AI era. Plus, discover how combining permit data with ReZone decisions can predict rezoning projects months or years before official announcements.
Image: /images/blog_images/2026-02-Newsletter.png
...
- A few weeks ago we got every non-engineer using [Claude Code](https://claude.com/product/claude-code). Claude Code lives in the command line. We onboarded teammates who had never opened Terminal before, completely new to shell scripts. Just showing them how to install [Homebrew](https://brew.sh/) was an eye-opener. And then… magic. They fully embraced the simplicity of command line tools. It's not without hiccups, and we may still ditch this for [Claude Cowork](https://claude.com/product/cowork), but the point is we tried and good things happened.
...
ICYMI, [we bought ReZone](https://www.shovels.ai/blog/shovels-acquires-rezone/) a couple of months ago. We're finally stitching the permits and decisions together and the results are super cool!
...
- Shovels address profile: [https://app.shovels.ai/detail/address-profile/DWcx_VqdlQE/](https://app.shovels.ai/detail/address-profile/DWcx_VqdlQE/)
- ReZone decision: [https://re-zone.ai/decisions/20251210-Chicago-124.json](https://re-zone.ai/decisions/20251210-Chicago-124.json)
...
- Shovels address profile: [https://app.shovels.ai/detail/address-profile/IUv6Hj2iqSA/](https://app.shovels.ai/detail/address-profile/IUv6Hj2iqSA/)
- ReZone decision: [https://re-zone.ai/decisions/20260203-Raleigh-9.json](https://re-zone.ai/decisions/20260203-Raleigh-9.json)
...
A very recent decision, linked above, shows the site is approved for Industrial Mixed Use-5 stories (IX-5) zoning, paving the way for a $15 million, 42-court pickleball facility. [WRAL reports](https://www.wral.com/lifestyle/15-million-pickleball-facility-proposed-north-raleigh-2025/) the facility will open in 2026, transforming a 7-acre warehouse into a recreation destination.
