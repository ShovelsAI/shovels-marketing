...
<div class="relative overflow-hidden pt-16">
  <div class="mx-auto max-w-7xl px-6 lg:px-8 max-h-screen">
    <img src="{attach}images/contractor-directory.png" alt="App screenshot" class="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-white/10" width="2432" height="1442">
...
<div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
  <dl class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
    ...
    <div class="relative pl-9">
      ...
      <dd class="inline">Evaluating bids? Look them up on Shovels to see current and past permit performance before you commit.</dd>
    </div>
    <div class="relative pl-9">
      <dt class="inline font-semibold text-white">
      ...
      <dd class="inline">Our contractor data is refreshed and re-processed constantly. We retrieve updates from our source data partners and supplement with our own retrieval systems.</dd>
    </div>
    <div class="relative pl-9">
      <dt class="inline font-semibold text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute top-1 left-1 h-5 w-5 text-slate-500">
      ...
      <dd class="inline">We calculate inspection pass rate and construction speed wherever it's available, providing an overall score and metrics by permit type.</dd>
    </div>
    <div class="relative pl-9">
      <dt class="inline font-semibold text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="absolute top-1 left-1 h-5 w-5 text-slate-500">
      ...
      <dd class="inline">We know how many jobs each contractor can usually handle and whether they have the capacity to add one more.</dd>
    </div>
    <div class="relative pl-9">
      <dt class="inline font-semibold text-white">
        <svg class="absolute top-1 left-1 h-5 w-5 text-slate-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
