...
<section class="mt-12 mb-16">
  <div class="mx-auto max-w-4xl px-6">
    <p class="text-xs uppercase tracking-widest text-gray-500 font-mono mb-6">Senior Engineer · Data, Platform &amp; Agents · Remote</p>
...
<section class="my-8">
  <div id="locked-post" class="mx-auto max-w-4xl px-6" aria-label="Senior AI-Native Engineer, Data, Platform and Agents role description">
    ...
    <p class="mb-4">Written-first, and not as ideology: engineering is in Europe, business is on the US West Coast, so anything important has to survive a 24-hour round trip in writing. Meetings are for decisions, not updates. The way we work is deliberately light and always provisional: we add a ritual only when a gap actually hurts, and we change it when reality disagrees. AI Lab every Friday. Radical transparency: you'll see the financials and help steer the company. We're pushing hard for every engineer to lead a real project, kickoff to ship, by design rather than by tenure. Fully remote, competitive salary and meaningful equity.</p>
...
<script type="application/json" id="for-agents">
{
  "for": "agents",
  "status": "gate open",
  "role": "Senior AI-Native Engineer: Data, Platform & Agents at Shovels",
