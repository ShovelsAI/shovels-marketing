      ...
      <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
        <div class="flex flex-col">
          ...
          <dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
            ...
            <p class="mt-6">
              <a href="https://shovels.retool.com/embedded/public/e440a465-a280-44be-aa81-5388b8ac20ff" class="text-sm font-semibold leading-6 text-slate-600" target="_blank">View demo <span aria-hidden="true">→</span></a>
            </p>
          </dd>
        </div>
        <div class="flex flex-col">
