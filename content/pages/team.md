...
<div class="bg-white py-24 md:py-32 lg:py-40">
  <div class="mx-auto grid max-w-7xl grid-cols-1 gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Team Shovels</h2>
    ...
    <ul role="list" class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-20 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-8 xl:col-span-2">
      <li>
        <img class="aspect-[3/2] w-full rounded-2xl object-cover" src="{attach}images/ryan.jpeg" alt="">
        <h3 class="mt-6 text-lg font-semibold leading-8 text-gray-900">Ryan Buckley</h3>
        <p class="text-base leading-7 text-gray-600">Co-founder & CEO</p>
        <p class="mt-4 text-base leading-7 text-gray-600">Ryan was most recently CEO of MightySignal, a B2B mobile SDK intelligence company. He also co-founded Scripted, which was backed by Redpoint, Storm, and Crosslink. Ryan holds Bachelor degrees from UC Berkeley and a MPP from the Harvard Kennedy School and an MBA from MIT Sloan.</p>
      ...
      <li>
        <img class="aspect-[3/2] w-full rounded-2xl object-cover" src="{attach}images/petra.jpeg" alt="">
        <h3 class="mt-6 text-lg font-semibold leading-8 text-gray-900">Petra Kopić</h3>
        <p class="text-base leading-7 text-gray-600">Data Engineer</p>
        <p class="mt-4 text-base leading-7 text-gray-600">Petra was most recently a data scientist at CIAL Dun & Bradstreet where she ran data pipelines on complex business data. At Shovels, she runs data pipelines on our permit analysis infrastructure.</p>
        <ul role="list" class="mt-6 flex gap-x-6">
          <li>
